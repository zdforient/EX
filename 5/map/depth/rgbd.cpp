...
int main(int argc, char** argv){
    ...
    double cx = 325.5, cy = 253.5, fx = 518.0, fy = 519;
    double depthScale = 1000;
    vector<Vector6d, Eigen::aligned_allocator<Vector6d>> pointcloud;
    pointcloud.reserve(1000000);
    
    for(int i = 0; i < 5; i++){
        cout<<"rotating image: "<<i + 1<<endl;
    ...
    cout << "there are totally "<<pointcloud.size() << " points."<<endl;
